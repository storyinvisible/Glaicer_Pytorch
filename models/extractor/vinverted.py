...
class VInvertedResidual(nn.Module):
    ...
    def __init__(self, in_channel = 5, output_dim = 256, **args):
        ...
        self.model = nn.Sequential(
            nn.Conv2d(in_channels = in_channel, out_channels = 16, kernel_size = (289, 1), stride=(1, 1), padding = 0),
            nn.LeakyReLU(0.2),
...
class VInvertedBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, expansion = 4, stride = (1, 1)):
        ...
        self.block = nn.Sequential(
            ...
            nn.LeakyRelu(0.2)
            nn.Conv2d(in_channels = in_channel * expansion, out_channels = in_channel * expansion, kernel_size = (1, 3), stride = stride, padding = (0, 1), groups = in_channel * expansion)
            nn.LeakyRelu(0.2)
